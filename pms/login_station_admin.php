...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "SELECT * FROM staff WHERE name = ? AND role = 'admin station'";
    ...
    if ($user && $password == $user['password']) { // Directly compare plain text password
        ...
        header('Location: admin_dashboard.php'); // Redirect to Admin Station Dashboard
        exit();
    } else {
...
<html lang="en">
<head>
    <title>Admin Station Login</title>
</head>
...
<div class="container">
    ...
    <h3 class="text-center-hed"> Login For PS-Admin</h3>
    <form method="POST">
        <div class="mb-3">
